...
abstract class AppUserRepository {
  ...
  Future<void> updateUserDataSharingSettings(UserDataSharingSettings userDataSharingSettings);
  Future<UserDataSharingSettings> getUserDataSharingSettings();
  Future<void> updateUserProfileInfo(UserProfileUpdateInfo updateData);
}
