...
class ProviderOnboardingInfo extends Equatable {
  ...
  ProviderOnboardingInfo.shimmer() {
    providerDetails = ProviderDetailsInfo.shimmer();
    generalService =GeneralService.shimmer();
    programs=List.generate(2, (index)=>Program.shimmer());
  }
