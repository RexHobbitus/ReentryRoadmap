...
class CheckInHappyDignify extends StatefulWidget {
  const CheckInHappyDignify({super.key});

  @override
  State<CheckInHappyDignify> createState() => _CheckInHappyDignifyState();
}

class _CheckInHappyDignifyState extends State<CheckInHappyDignify> {
  String selected = "";
  ...
  void initState() {
    super.initState();
    selected = cubit.experienceWithDignifi;
  }

  void _onNumberTap(String rating) {
    setState(() {
      selected = rating;
      cubit.experienceWithDignifi = rating;
    ...
    return Column(
      children: [
        const CheckInTitleWidget(
          title: "How would you rate your experience with Dignifi so far?",
        ),
        Row(
        ...
        Row(
          ...
          children: List.generate(5, (index) {
            ...
            return GestureDetector(
              onTap: () {
                _onNumberTap(number);
                print(cubit.experienceWithDignifi);
              },
              child: Container(
