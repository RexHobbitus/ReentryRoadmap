...
class ContactedServices extends StatelessWidget {
  const ContactedServices({super.key});
      ...
      child: CustomResponsiveBuilder(
        builder: (context, constraints, deviseSize) {
          return context.read<MyServicesCubit>().filteredServices.isEmpty
              ...
              title: "You haven’t contacted any service provider yet",
              desc: "Service providers you contact will appear here") :Center(
            child: Wrap(
              spacing: 20,
              runSpacing: 20,
