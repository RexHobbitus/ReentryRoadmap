...
import '../../../write_review/add_photos_button.dart';
import '../../../write_review/write_review_parameter.dart';



/// This New Review Card must be merged with the Review Card Widget so that the code is not duplicated
class NewReviewCard extends StatefulWidget {
  Function(WriteReviewParameter)? onPostReview;

  NewReviewCard({super.key, this.onPostReview});

  @override
  State<NewReviewCard> createState() => _NewReviewCardState();
}

class _NewReviewCardState extends State<NewReviewCard> {
  String _review = "";
  double _rating = 0;
