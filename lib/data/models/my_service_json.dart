...
class MyServiceJson {
  ...
  MyServiceJson({this.provider, this.serviceStatus, this.statusUpdates});
  ...
  MyServiceJson.fromJson(Map<String, dynamic> json) {
    provider =
        json['provider'] != null ? ProviderJson.fromJson(json['provider']) : null;
  ...
  MyServicesStatus? myServicesStatusFromString(String myServiceStatus) {
    return MyServicesStatus.values.firstWhere(
          (myServicesStatus) => myServicesStatus.toString().split('.').last == myServiceStatus,
